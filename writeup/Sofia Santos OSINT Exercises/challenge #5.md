...
Step 3: Find the Exact Coordinates

Next, I located a map and infographic of the San Diego Zoo to determine where the polar bear enclosure was located. After identifying the correct zone, I opened Google Maps and then switched to Google Earth for a better satellite view.
...
This challenge required reverse image search, historical weather verification, and careful satellite map comparison to determine precise coordinates.
